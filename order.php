...
if(isset($_SESSION['id'])){
    ...
    $qry="INSERT INTO tb_order(id,date,name,age,purpose,quntity,price,total)VALUES('$id','$date','$name','$age','$purpose','$quantity',' $price','$total')";
...
<article class="card-body mx-auto py-0" style="max-width: 400px;">
	...
	<div class="form-group input-group">
        ...
        <input name="date" class="form-control" style=" font-weight:600" value="<?php echo date('d/m/Y'); ?>"  type="date">   
    </div> <!-- form-group// -->
    <div class="form-group input-group">
