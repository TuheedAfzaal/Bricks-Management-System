  ...
  <div class="collapse navbar-collapse" id="navbarSupportedContent">
    <ul class="navbar-nav mr-auto ">
      ...
      <li class="nav-item">
       ...
       <li class="nav-item">
        <a class="nav-link text-white px-3" href="<?php echo site_url?>/all_order.php?view=<?php echo $id;?>">Your Order</a>
      </li>
       <li class="nav-item">
        <a class="nav-link text-white px-3" href="<?php echo site_url?>/complain.php?view=<?php echo $id;?>">Complain</a>
      </li>
    </ul>
    <?php if($logout==true){ ?>
